...
public class InnerArrayFmt1 extends RecordsTable<NumRecord> {
  ...
  public InnerArrayFmt1(ReadableFontData data, boolean dataIsCanonical) {
  ...
  RecordsTable.Builder<InnerArrayFmt1, NumRecord> {
    ...
    protected InnerArrayFmt1 readTable(ReadableFontData data, int base, boolean dataIsCanonical) {
      ...
      return new InnerArrayFmt1(data, dataIsCanonical);
    }

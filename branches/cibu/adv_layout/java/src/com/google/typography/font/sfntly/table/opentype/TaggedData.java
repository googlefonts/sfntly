...
public interface TaggedData {
  /**
   * @param string label
   * @param start start of range to tag
   * @param length length of range to tag
   * @param depth nesting depth of range
   */
  ...
  static enum FieldType {
    TAG, SHORT, SHORT_IGNORED, SHORT_IGNORED_FFFF, OFFSET, OFFSET_NONZERO;
  }
}

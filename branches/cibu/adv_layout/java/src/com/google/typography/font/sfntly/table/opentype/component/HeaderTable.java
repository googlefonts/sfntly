...
public abstract class HeaderTable extends SubTable {
  ...
  public HeaderTable(ReadableFontData data) {
    super(data);
  }
  
  public HeaderTable(ReadableFontData data,  boolean dataIsCanonical) {
    super(data);
  ...
  public int getField(int index) {
    return data.readUShort(index * FIELD_SIZE);
  }
  ...
  class Builder<T extends SubTable> extends VisibleBuilder<T> {

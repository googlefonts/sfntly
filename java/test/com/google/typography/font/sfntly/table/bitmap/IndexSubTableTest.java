...
public class IndexSubTableTest extends TestCase {
  ...
  public void testToString() {
    ReadableFontData data = ReadableFontData.createReadableFontData(new byte[] {
        0, 1, // indexFormat
        0, 17, // imageFormat
        0, 0, 0, 8 // imageDataOffset
    });

    IndexSubTable table = new IndexSubTable(data, 'a', 'a') {
      @Override
    ...
    String expected = String.format("%s%n",
        "IndexSubTable: [0x61 : 0x61], format = 1, image format = 17, imageOff = 0x8");

...
/**
 * The tree in the left panel is built from these nodes.
 * Most of these nodes correspond to a "table" of the font.
 *
 * @see FontNode
 */
abstract class AbstractNode extends DefaultMutableTreeNode {
  ...
  /**
   * Whether the component from {@link #render()} is wrapped in a {@link JScrollPane}
   * so that it can be arbitrarily large.
   * Otherwise it can easily be truncated on small screens.
   */
